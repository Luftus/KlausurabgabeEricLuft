...
var pItemName = document.getElementById('itemName');
var emailField = document.getElementById('email');
var nameFeld = document.getElementById('name');
var submitReserve = document.getElementById('submit-reserve');
if (submitReserve) {
    submitReserve.addEventListener('click', reserveItem);
}
function startReserve() {
    var itemName = localStorage.getItem('toReserve');
...
function reserveItem(evt) {
    return __awaiter(this, void 0, void 0, function () {
        var name, email, itemName, params, reserveRequest, reserveResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    itemName = localStorage.getItem('toReserve');
                    ...
                    return [4 /*yield*/, fetch(main_url + '/ReserveItem?' + params.toString())];
                case 1:
                    reserveRequest = _a.sent();
                    return [4 /*yield*/, reserveRequest.json()];
                case 2:
